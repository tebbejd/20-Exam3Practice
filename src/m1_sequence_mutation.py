...
def run_test_zero_changer():
    ...
    # Test 2:
    test2 = ([5, 4, 3, 0, 9], [0, 0, 0], [3, 10, 43])
    expected2 = ([5, 4, 3, 1, 9], [2, 3, 4], [3, 10, 43])
    zero_changer(test2)
    print()
    print('Test 2:')
    ...
    # Test 3:
    test3 = ([0, 0, 0, 1, 2, 3], [1, 2, 4, 5, 0, 5], [30, 40, 10], [])
    expected3 = ([1, 2, 3, 1, 2, 3], [1, 2, 4, 5, 4, 5], [30, 40, 10], [])
    zero_changer(test3)
    print()
    print('Test 3:')
